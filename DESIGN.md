...
colors:
  graphite-rail: "#202421"
  graphite-control: "#303630"
  workshop-canvas: "#e9ece8"
  work-surface: "#f8faf7"
  muted-surface: "#eef1ed"
  divider: "#c9cec8"
  divider-strong: "#9ca59d"
  text-primary: "#202421"
  text-muted: "#59635b"
  route-healthy: "#14786f"
  route-healthy-deep: "#0d5d56"
  command-orange: "#d6522e"
  command-orange-deep: "#ae3d20"
  status-warning: "#9a6710"
  status-danger: "#b2372f"
  focus-blue: "#1872a5"
typography:
  headline:
